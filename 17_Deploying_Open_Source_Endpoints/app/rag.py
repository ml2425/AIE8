...
- Embeds chunks with Together AI and stores vectors in an in-memory Qdrant store.
...
def _build_rag_graph(data_dir: str) -> "CompiledGraph":
    ...
    generator_llm = ChatTogether(model=os.environ.get("TOGETHER_MODEL", "openai/gpt-oss-20b"))
